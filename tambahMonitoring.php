    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
      ...
      <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
          <div >
            <h4 class="page-title">Tambah Data Project</h4>
          </div>
      ...
      <div class="container-fluid">
        <form action="" method="POST" enctype="multipart/form-data" id="regForm">
            <input type="hidden" name="id_projectLeader" value="<?= $ambilData["id"]; ?>">
          <div class="row">
            <div class="col-md-12">
              <div class="tab">
                ...
                <div style="margin-top: 15px;" class="form-group">
                  ...
                  <input name="namaProject" id="namaProject" class="form-control" type="text" placeholder="Masukkan Judul Project" required>
                </div>
                ...
                <div class="form-group d-flex"> 
                 ...
                 <div style="margin-top: 15px;" class="form-group">
                  ...
                  <input name="batasProject" id="batasProject" class="form-control" type="date" placeholder="Masukkan Deadline Project" required>
                </div>

                <div style="margin-top: 15px;" class="form-group">
                  <label for="harga" class="control-label">Harga</label>  <br>
                  <i>Contoh : 1000000</i>
                  <input name="harga" id="harga" class="form-control" type="number" placeholder="Masukkan harga project" required>
                </div>
