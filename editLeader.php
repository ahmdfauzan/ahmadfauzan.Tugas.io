...
$ambilData = query("SELECT * FROM projectleader WHERE id_projectLeader = $id ")[0];

// $ambilData = query("SELECT * FROM projectleader INNER JOIN listproject ON projectleader.id_projectLeader = listproject.id_projectLeader WHERE projectleader.id_projectLeader = $id ")[0];
// var_dump($ambilData);

if (isset($_POST["submit"])) {
  // Cek apakah data sudah ditambhakan 
  if (editLeader($_POST) > 0) {
    echo "
          <script>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
      ...
      <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
          <div >
            <h4 class="page-title">Tambah Data Project Leader</h4>
          </div>
      ...
      <div class="container-fluid">
        <form action="" method="POST" enctype="multipart/form-data" id="regForm">
             <input type="hidden" name="id_projectLeader" value="<?= $ambilData["id_projectLeader"]; ?>">
          <div class="row">
            <div class="col-md-12">
              <div class="tab">
                ...
                <div style="margin-top: 15px;" class="form-group">
                  <label for="namaLeader" class="control-label">Nama Leader Project</label>
                  <input name="namaLeader" id="namaLeader" class="form-control" type="text" value="<?= $ambilData["namaLeader"]; ?>" required>
                </div>

                <div style="margin-top: 15px;" class="form-group">
                  <label for="email" class="control-label">Email</label>
                  <input name="email" id="email" class="form-control" type="text" value="<?= $ambilData["email"]; ?>" required>
                </div>

                <div class="form-group">
                  <label for="foto" class="control-label">Foto</label> <br>
                  <i>Max upload foto 1MB dalam bentuk (JPEG,PNG,JPG)</i>
                  <input name="foto" id="foto" class="form-control" value="<?= $ambilData["foto"]; ?>" type="file" required>
                </div>
                
                <div style="margin-top: 15px;" class="form-group">
                  <label for="mulaiProject" class="control-label">Start Project</label>
                  <input name="mulaiProject" id="mulaiProject" class="form-control" type="date" value="<?= $ambilData["mulaiProject"]; ?>" required>
                </div>

                <div style="margin-top: 15px;" class="form-group">
                  <label for="progress" class="control-label">Progres Project</label>
                  <input name="progress" id="progress" class="form-control" type="text" value="<?= $ambilData["progress"]; ?>" required>
                </div>
