...
// $ambilData = query("SELECT * FROM client WHERE id_client = $id ")[0];
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
      ...
      <div class="page-breadcrumb bg-white">
        <div class="row align-items-center">
          <div >
            <h4 class="page-title">Edit Data Client</h4>
          </div>
      ...
      <div class="container-fluid">
        <form action="" method="POST" enctype="multipart/form-data" id="regForm">
            <input type="hidden" name="id_client" value="<?= $ambilData["id_client"]; ?>">
          <div class="row">
            <div class="col-md-12">
              <div class="tab">
                ...
                <div style="margin-top: 15px;" class="form-group">
                  ...
                  <input name="nama" id="nama" class="form-control" type="text" value="<?= $ambilData["nama"]; ?>" required>
                </div>

                <div style="margin-top: 15px;" class="form-group">
                  <label for="institusi" class="control-label">Institusi</label><br>
                  <i>Contoh: Universitas Malang</i>
                  <input name="institusi" id="institusi" class="form-control" type="text" value="<?= $ambilData["institusi"]; ?>" required>
                </div>

                <div style="margin-top: 15px;" class="form-group">
                  <label for="umur" class="control-label">Umur</label>
                  <input name="umur" id="umur" class="form-control" type="text" value="<?= $ambilData["umur"]; ?>" required>
                </div>
