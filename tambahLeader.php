            ...
            <div class="col-md-12">
              <div class="tab">
                ...
                <div style="margin-top: 15px;" class="form-group">
                  ...
                  <input name="namaLeader" id="namaLeader" class="form-control" type="text" placeholder="Masukkan nama yang menghandel project" required>
                </div>

                <div style="margin-top: 15px;" class="form-group">
                  <label for="email" class="control-label">Email</label>
                  <input name="email" id="email" class="form-control" type="text" placeholder="Masukkan email" required>
                </div>

                <div class="form-group">
                  <label for="foto" class="control-label">Foto</label> <br>
                  <i>Max upload foto 1MB dalam bentuk (JPEG,PNG,JPG)</i>
                  <input name="foto" id="foto" class="form-control" type="file" required>
                </div>
                
                <div style="margin-top: 15px;" class="form-group">
                  <label for="mulaiProject" class="control-label">Start Project</label>
                  <input name="mulaiProject" id="mulaiProject" class="form-control" type="date" placeholder="Masukkan tanggal mulai pengerjaan" required>
                </div>

                <div style="margin-top: 15px;" class="form-group">
                  <label for="progress" class="control-label">Progres Project</label>
                  <input name="progress" id="progress" class="form-control" type="text" placeholder="Progress" required>
                </div>
