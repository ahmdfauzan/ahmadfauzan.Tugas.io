...
$dataAmbil = mysqli_query($conn, "SELECT * FROM client");
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="tile-title-w-btn">
                                                <div class="btn-group">
                                                    <a class="btn btn-primary" href="tambahClient.php"><i class="fas fa-plus"></i></a>

                                                    <a class="btn btn-primary" href="editClient.php?id_client=<?= $row["id_client"]; ?>"><i class="fas fa-edit"></i></a>

                                                    <a class="btn btn-primary" href="hapusClient.php?id_client=<?= $row["id_client"]; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data?');"><i class="fas fa-trash"></i></a>
                                                </div>
                                            </div>
                                        </td>
                                        <?php $i++ ?>
